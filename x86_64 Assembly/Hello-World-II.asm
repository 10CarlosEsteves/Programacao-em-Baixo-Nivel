...
section .data                    ; Define o trecho como uma sessão de dados
...
section .text                    ; Define o trecho como sessão de texto, na prática, isso serve apenas para estruturar o código.
...
_start:                          ; Outro rótulo, dessa vez para definir um procedimento em ASM. Nosso objetivo é chamar o SO e imprimir na tela uma message.
    mov rax, 1                   ; RAX funciona armazenando o código da chamada do sistema, no caso, estamos chamando o write(). 
    mov rdi, 1                   ; RSD, registrador que armazena aonde deve ser enviado nossa string. No caso, 1 significa stdout, ou seja, a tela.
